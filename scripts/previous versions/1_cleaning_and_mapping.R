...
###limiting to grades 7 - 9 
#raw_data = raw_data %>% dplyr::filter(q3 =='A'|q3 =='B'|q3 =='C')
...
#####
# •	Number of Reponses across the questions: with less than 20 responses
...
## Filtering out records with at least 20 variables with missing data
  ...
  # •	Too many similar responses in a row: 15 LETTERS or more times except for A
  ...
  # •	Variable completeness: 60%, variable gets dropped
...
#
#The next loop sets missingness to where there are discrepancies
